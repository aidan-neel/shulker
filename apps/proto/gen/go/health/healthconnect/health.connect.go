...
import (
	...
	context "context"
	errors "errors"
	health "github.com/aidan-neel/shulker/apps/proto/gen/go/health"
	http "net/http"
	strings "strings"
)
...
// HealthServiceClient is a client for the health.HealthService service.
type HealthServiceClient interface {
	Check(context.Context, *connect.Request[health.HealthCheckRequest]) (*connect.Response[health.HealthCheckResponse], error)
}

// NewHealthServiceClient constructs a client for the health.HealthService service. By default, it
...
// Check calls health.HealthService.Check.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/health.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[health.HealthCheckRequest]) (*connect.Response[health.HealthCheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("health.HealthService.Check is not implemented"))
}
