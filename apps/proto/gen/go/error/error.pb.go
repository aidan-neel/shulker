...
const file_error_error_proto_rawDesc = "" +
	"\n" +
	"\x11error/error.proto\x12\x05error\x1a\x1cgoogle/api/annotations.proto\"=\n" +
	"\rErrorResponse\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessageB=Z;github.com/aidan-neel/shulker/apps/proto/gen/go/error;errorb\x06proto3"
