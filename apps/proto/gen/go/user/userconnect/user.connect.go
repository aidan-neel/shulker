...
const (
	...
	UserServiceGetAllUsersProcedure = "/user.UserService/GetAllUsers"
)
...
type UserServiceClient interface {
	...
	GetAllUsers(context.Context, *connect.Request[user.GetAllUsersRequest]) (*connect.Response[user.GetAllUsersResponse], error)
}
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		...
		getAllUsers: connect.NewClient[user.GetAllUsersRequest, user.GetAllUsersResponse](
			httpClient,
...
type userServiceClient struct {
	...
	getAllUsers *connect.Client[user.GetAllUsersRequest, user.GetAllUsersResponse]
}
...
// GetAllUsers calls user.UserService.GetAllUsers.
func (c *userServiceClient) GetAllUsers(ctx context.Context, req *connect.Request[user.GetAllUsersRequest]) (*connect.Response[user.GetAllUsersResponse], error) {
...
func (UnimplementedUserServiceHandler) GetAllUsers(context.Context, *connect.Request[user.GetAllUsersRequest]) (*connect.Response[user.GetAllUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("user.UserService.GetAllUsers is not implemented"))
}
